            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header card-header-info">
                        ...
                        <p class="card-category">Add New Trip</p>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('trip') }}" method="POST" class="form-horizontal">
                            {!! csrf_field() !!}
                                ...
                                @foreach($tours as $t)
                                    <option value="{{ $t->Tour_No }}">{{ $t->Tour_No }} : {{ $t->Tour_Name }}</option>
                                @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="Max_Passengers" id="Max_Passengers" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="Standard_Amount" class="col-sm-12 control-label">Standard Amount</label>
                                    <input type="number" name="Standard_Amount" id="Standard_Amount" class="form-control">
                                </div>
                            </div>
